...
public class ShadowTests {
    ...
    public void SphereTriangleSpot1() {
        ...
        ImageWriter imageWriter = new ImageWriter("sphereTriangleSpot1new", 200, 200, 400, 400);
    ...
    public void SphereTriangleSpot3() {
        ...
        scene.addLight(
                new SpotLight(
                        new Color(400, 240, 0), //
                        new Point3D(-76, 76, -70),
                        new Vector(1, -1, 3),
                        1, 1E-5, 1.5E-7));

        ImageWriter imageWriter = new ImageWriter("sphereTriangleSpot3", 200, 200, 400, 400);
        Render render = new Render(imageWriter, scene);
