...
public class Color {
    ...
    private final double COLORGAP = 5d;
    /**
    ...
    public boolean equals(Object other) {
        ...
        double rgap = alignZero(COLORGAP - Math.abs(this._r - color._r));
        double ggap = alignZero(COLORGAP - Math.abs(this._g - color._g));
        double bgap = alignZero(COLORGAP - Math.abs(this._b - color._b));
